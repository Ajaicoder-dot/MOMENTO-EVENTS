...
<div class="container">
    ...
    <div class="hero">
        <div>
            <h1>Welcome to Momento Events Management</h1>
        ...
        <img src="image/logo 2.jpg" alt="Event Management">
    </div>
    ...
    <div class="timeline">
        <div class="timeline-item">
            <div class="timeline-item-content">
                ...
                <p>Native Event Management started as a small team passionate about event planning.</p>
            </div>
        </div>
        <div class="timeline-item">
            <div class="timeline-item-content">
